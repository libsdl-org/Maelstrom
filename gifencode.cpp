...
void
GIFEncode(FILE* fp, int GWidth, int GHeight, int GInterlace,
...
static void compress( int init_bits, FILE* outfile )
{
    ...
    /*
     * Initialize the compress constants, etc 
     */
    maxbits = GIF_BITS;
    maxmaxcode = (1<<GIF_BITS);
...
static void writeerr(void)
{
        perror( "Error writing GIF output file" );
}
